  ...
  key: import.meta.env.VITE_PUBLIC_KEY,
    ...
    emailjs
      ...
      .then(
        ...
        (err) => {
          console.error("EmailJS error:", err); // regarde le détail dans la console
          setError(true);
          setSuccess(false);
        }
      );
      ...
      <div className="cSection">
        ...
        >
          ...
          <motion.div variants={listVariant} className="formItem">
            <label>Name</label>
            <input type="text" name="user_username" placeholder="Nom Prenom" />
          </motion.div>
          <motion.div variants={listVariant} className="formItem">
            <label>Email</label>
            <input
          ...
          {error && <span>Une erreur est survenue, réessayez.</span>}
        </motion.form>
      </div>
